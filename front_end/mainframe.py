...
class CanvasPanel(wx.Frame):
	def __init__(self):
		wx.Frame.__init__(self, None, -1, "Cyclone2", size=(510,300), pos=((wx.DisplaySize()[0])/2,(wx.DisplaySize()[1])/2), 
		...
		If you have your own personal authentication code, Please press yes
		Otherwise, press no to make a new registration.
		"""
		...
		self.button_one = wx.Button(self.button_panel, ID_ONE, label='Yes', size=(150, 30))
		self.button_two = wx.Button(self.button_panel, ID_TWO, label='No', size=(150, 30))
		self.button_three = wx.Button(self.button_panel, ID_THREE, label='Close', size=(150, 30))
		...
		self.button_box.Add(self.button_one, wx.EXPAND|wx.ALL, 3)
		self.button_box.Add(self.button_two, wx.EXPAND|wx.ALL, 3)
		self.button_box.Add(self.button_three, wx.EXPAND|wx.ALL, 3)

		self.button_panel.SetSizer(self.button_box)
		self.hbox.Add(self.panel, 4, wx.EXPAND | wx.ALL, 3)
		self.hbox.Add(self.button_panel, 1, wx.EXPAND | wx.ALL)
